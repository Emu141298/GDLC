...
describe('GDIC CI Motor test', () => {
  ...
  cy.get('.ng-dropdown-panel .ng-option').each(($el, index, $list) => {
    ...
    if (optionText === 'Double Deck Bus') {
        cy.wrap($el).scrollIntoView().click({ force: true });
        cy.log('Double Deck Bus found and clicked!');
    }
  });
  ...
  cy.get('input[formcontrolname="motorEngineAndChassisNumber"]')
    ...
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(4) > .input-group > .form-control').type(' Poristhan')
  
    //Manufacturer year
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(5) > .input-group > .form-control').type('2010')
  ...
  cy.get('ng-select[formcontrolname="mtrCcTon"]')
    .should('contain', 'SEAT');
  //SEAT value
    cy.get(':nth-child(12) > .input-group > .form-control').type('61')
  ...
  cy.get('.flex.mt-10 > :nth-child(2) > .select-group > .ng-select > .ng-select-container > .ng-value-container > .ng-input > input').type('{enter}')
    ...
    cy.screenshot('1st Quotation_Double Deck Bus')
   //submission 
    ...
    cy.get('.mr-10 > .ng-select > .ng-select-container > .ng-value-container > .ng-input > input').type('2001{enter}')
     ...
     cy.get('.form-footer > :nth-child(2) > .btn').click()
     cy.screenshot('Preview_Double Deck Bus')
  ...
  cy.screenshot('Riot strike added preview_Double Deck Bus')
  cy.wait(1000)
